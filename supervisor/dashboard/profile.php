          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                ?>
                <!-- profile update form -->
                <form class="forms-sample mb-4" action="./Admin_Form_Handler/updates.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" value="<?php echo $id; ?>" name="id">
                  <div class="form-group">
                    <label>Full Name</label>
                    <input type="text" name="username" class="form-control" value="<?php echo $data["name"];  ?>" placeholder="Full Name" required>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                ...
                <form class="forms-sample mb-4" action="./Admin_Form_Handler/updates.php" method="post">
