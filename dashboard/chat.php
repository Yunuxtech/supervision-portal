          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                $sql1 = "SELECT * FROM `assigned_student_tbl` WHERE student_id = '$studentId'";
                ...
                if ($num < 1) {
                ?>
                  Start chatting with your supervisor... <i class="mdi mdi-emoticon-happy"></i>
                  <div class="mesgs" style="width: 100%;">
                    <div class="type_msg">
                      <div class="input_msg_write">
                        <form action="../Form_Handler/chat-message.php" method="post">
                          <input type="hidden" name="studentId" id="" value="<?php echo $studentId; ?>">
                          <input type="hidden" name="supervisorId" id="" value="<?php echo $supervisorId; ?>"> <input type="text" class="write_msg" placeholder="Type a message" name="message" required />
